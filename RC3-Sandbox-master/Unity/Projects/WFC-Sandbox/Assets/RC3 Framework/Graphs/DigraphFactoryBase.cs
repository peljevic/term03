...
namespace RC3.Graphs
{
        ...
        where G : IDigraph
    {
        ...
        public G CreateRhombicDodecahedronGrid(int countX, int countY, int countZ, bool uniform = false)
        {
            return uniform ?
                CreateRhombicDodecahedronGridUniform(countX, countY, countZ) :
                CreateRhombicDodecahedronGridDefault(countX, countY, countZ);
        }
        ...
        private G CreateRhombicDodecahedronGridDefault(int countX, int countY, int countZ)
        {
            var g = Create();
            int countXY = countX * countY;
            int count = countXY * countZ;
        ...
        /// 
        /// </summary>
        private G CreateRhombicDodecahedronGridUniform(int countX, int countY, int countZ)
        {
            var g = Create();
            int countXY = countX * countY;
            int count = countXY * countZ;
